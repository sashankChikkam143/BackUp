...
export default function SelectedUsers({data}) {
  ...
  return (
    <React.Fragment>
      <Button onClick={handleClickOpen('paper')} size='large' variant='contained' sx={{textTransform:'none',borderRadius:'20px', marginLeft:'2px',marginRight:'auto'}}><b>show selected</b></Button>
      <Dialog
        open={open}
        onClose={handleClose}
        // scroll={scroll}
      ...
      >
        <DialogTitle id="scroll-dialog-title">selected users - {data.length}</DialogTitle>
        <DialogContent dividers={scroll === 'paper'}>
        <OneDriveFilesTable data={data} columns={columns} />
        </DialogContent>
        <DialogActions>
